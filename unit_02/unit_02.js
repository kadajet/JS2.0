...
function t10() {
  out10.innerHTML = (input10.value / 1 == input10.value) ? input10.value * 10 : 'fuck u';
}
...
let input12 = document.querySelector('.i-12_1');
let input12_2 = document.querySelector('.i-12_2');
let out12 = document.querySelector('.out-12');
function t12() {
  out12.innerHTML = `Hello ${input12.value} ${input12_2.value}`
}
...
function t19() {
  let input19_1Value = +document.querySelector('.i-19-1').value;
  let input19_2Value = +document.querySelector('.i-19-2').value;
  let out19 = document.querySelector('.out-19');
  out19.innerHTML = input19_1Value + input19_2Value;
}
...
function t20() {
  let firstNameValue = document.querySelector('.i-20-firstName').value
  let lastNameValue = document.querySelector('.i-20-lastName').value
  let ageValue = document.querySelector('.i-20-age').value
  let professionValue = document.querySelector('.i-20-profession').value
  let out20 = document.querySelector('.out-20')

  out20.innerHTML = `Уважаемый ${firstNameValue}, ${lastNameValue}, ваш возраст ${ageValue} года, по професси вы ${professionValue}`
}
