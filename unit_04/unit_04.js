...
function f4() {
    let i = document.querySelector('.i-4');
    let out = document.querySelector('.out-4');

    out.innerHTML = i.checked ;
}
...
function f5() {
    let i = document.querySelector('.i-5');
...
function f8() {
    ...
    out.innerHTML = '<input class="i-81" type="text">';
...
function f81 () {
    ...
    let i = document.querySelector('.i-81');
...
function f9() {
    let i = document.querySelector('.r-9');
...
function f10() {
    ...
    out.style.backgroundColor = i.value;
}
...
function f14() {
    let i = document.querySelector('.t-14');
...
function f15() {
    let i1 = document.querySelector('.i-15');
    let i2 = document.querySelector('.t-15');
    let out = document.querySelector('.out-15');

    i2.value = out.innerHTML = i1.value
}
