...
function f3(){
  let input_1Value = +document.querySelector('.i-31').value;
  let input_2Value = +document.querySelector('.i-32').value;
  let out = document.querySelector('.out-3');

  out.innerHTML = (input_1Value > input_2Value) ? input_1Value : input_2Value;
}
...
function f7(){
  let input_1Value = document.querySelector('.i-71').value;
  let input_2Value = document.querySelector('.i-72').value;
  let out = document.querySelector('.out-7');

  out.innerHTML = input_1Value ** input_2Value
}
...
function f13(){
  let inputValue = document.querySelector('.i-130').value;
  let out = document.querySelector('.out-13');

  out.innerHTML = (typeof inputValue)
}
...
function f15(){
  let selectValue_1 = +document.querySelector('.s-151').value;
  let selectValue_2 = +document.querySelector('.s-152').value;
  let selectOperatorValue = document.querySelector('.s-153').value;
  let out = document.querySelector('.out-15')

  if (selectOperatorValue == '&&') {
    out.innerHTML = selectValue_1 && selectValue_2;
  } else if (selectOperatorValue == '||') {
    out.innerHTML = selectValue_1 || selectValue_2;
  }
